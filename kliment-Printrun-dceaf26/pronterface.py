...
class PronterWindow(wx.Frame,pronsole.pronsole):
    def __init__(self, filename=None,size=winsize):
        ...
        self.settings.build_dimensions = '150x150x150-75-75+0' #default build dimensions are 200x200x100 with 0,0,0 in the corner of the bed
