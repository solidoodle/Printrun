...
class pronsole(cmd.Cmd):
    def __init__(self):
        ...
        self.bedtemps={"pla":"60","abs":"80","off":"0"}
        self.percentdone=0
        self.tempreadings=""
        self.macros={}
        ...
        self.helpdict["bedtemp_abs"] = _("Heated Build Platform temp for ABS (default: 80 deg C)")
        ...
        self.helpdict["temperature_abs"] = _("Extruder temp for ABS (default: 200 deg C)")
